...
export class MisrecetasComponent   {
  ...
  constructor(private router: Router, private servicioDB: DbrecetaService, private socialSharing: SocialSharing,private ToastController:ToastController,private elasticMailService:ElasticMailService) { }
